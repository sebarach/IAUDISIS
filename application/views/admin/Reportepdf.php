<html>
    ...
    <?php
        ...
        echo '<main><br><br><br>
                <h2 class="title">'.$fotos[0]["nombre"].'</h2>
                <br><br><br><br><br>
                <h2 class="title">FE - '.$fotos[0]["mes"].'</h2>
            </main>
        ...
        foreach($fotos as $f){
            ...
            echo'<main>
                    <h1 class="h3">'.$f["nombre"].'</h1><br><br>
                    <table>
                        <tr>
                            <td>
                                <div class="card">
                                    <img  src="'.$f["foto"].'" width="420" height="445">
                                </div>
                            </td>
                            <td>
                                <div class="card">
                                    <div class="card-body ecom-widget-sales" >
                                        <ul>
                                            <li>Usuario: <span>'.$f["usuario"].'<br><br></span></li>
                                            <li>Fecha Registro: <span>'.$f["fecha_registro"].'<br><br></span></li>
                                            <li>Local: <span>'.$f["nombrelocal"].'<br><br></span></li>
                                            <li>Pregunta: <span>'.$f["titulopreguntaestatica"].'<br><br></span></li>
                                        </ul>
                                    </div>
                                </div>
                            </td>

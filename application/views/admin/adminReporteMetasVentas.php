<main class="main" style="height: 100%;">
	<ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
        ...
        <li class="breadcrumb-item active">Reporte Masiva Metas y Ventas</li>
    </ol>
    <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class='col-md-4' style="margin-top: 13px !important;">
                                        ...
                                        <div class='input-group'>
                                            ...
                                            <select class="form-control select2" id='txt_fechas' name='txt_fechas' style="width: 100%;" onchange="buscarLocalesMetas();">
